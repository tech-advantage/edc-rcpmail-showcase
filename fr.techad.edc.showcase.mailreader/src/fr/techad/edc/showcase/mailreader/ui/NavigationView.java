...
public class NavigationView extends ViewPart {
	public static final String ID = "edc.navigationView";
    ...
    private TreeObject createDummyModel() {
        ...
        TreeParent p1 = new TreeParent("support@easydoccontents.com");
        p1.addChild(to1);
        p1.addChild(to2);
        p1.addChild(to3);

        TreeObject to4 = new TreeObject("Inbox");
        TreeParent p2 = new TreeParent("info@easydoccontents.com");
        p2.addChild(to4);
	...
	public void createPartControl(Composite parent) {
		...
		PlatformUI.getWorkbench().getHelpSystem().setHelp(parent, HelpKey.NAVIGATION_VIEW);
	}
